...
(2, 'Accion/Fantasía', 'Jumanji ', 'Jumanji: Bienvenidos a la jungla', 2017, 'https://www.youtube.com/watch?v=sLsT0KOZ0lM', ' Cuatro adolescentes encuentran un viejo videojuego que los absorbe y los transporta a una selva pel', 'img/Crepusculo.jpg'),
(3, ' Accion/Ciencia ficción', 'Rampage', 'Proyecto Rampage', 2018, 'https://www.youtube.com/watch?v=rLBQmoPmWps', 'Un gorila, un lobo y una serpiente sufren una mutación genética y se convierten en seres gigantescos', 'img/Crepusculo.jpg'),
...
(21, 'Accion', 'The expendables', 'Los mercenarios', 2010, 'https://www.youtube.com/watch?v=7k4SR6ZwjUQ', 'Un grupo de mercenarios es contratado para infiltrarse en un país sudamericano y derrocar a su despi', 'img/Crepusculo.jpg'),
(22, 'Accion', 'Mision impossible', 'Mision Imposible', 1997, 'https://www.youtube.com/watch?v=DZ2JjyNCwZw', 'Ethan Hunt es un superespía capaz de resolver cualquier arriesgada situación con la máxima elegancia', 'img/Crepusculo.jpg'),
(23, 'Accion', 'Allegiant', 'La serie divergente; Leal', 2016, 'https://www.youtube.com/watch?v=ZADtFSGajs0', 'Tras las revelaciones trascendentales de \'Insurgente\', Tris debe escapar con Cuatro e ir más allá de', 'img/Crepusculo.jpg'),
